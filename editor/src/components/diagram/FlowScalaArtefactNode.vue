...
/**
 * Vue Flow node for a Scala-artefact leaf box (`type: 'artefact'`). Sibling of
 * {@link FlowPackageNode} / {@link FlowProjectNode}: hosts a {@link ScalaArtefactBox}, wires the
 * standard aggregate target / source handles, and reuses the same focus / pin / accent infra
 * as the project and package boxes so layered layout, drill-in and hover dimming all work
 * uniformly across diagrams.
 *
...
<template>
  <div class="flow-graph-node flow-graph-node--artefact">
